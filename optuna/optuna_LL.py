...
if __name__ == '__main__':
    ...
    study = optuna.create_study(study_name="LL_cent_noCobra_MEGonly", storage='sqlite:////data/project/general/muonGroup/simulations/giovanni/PepperPotCheck/DBs/LL_cent_noCobra_MEGonly.db', direction='minimize', load_if_exists=True)
    if len(args) == 1:
